...
const PLAY_STYLES: PlayStyleOption[] = [
  {
    ...
    description: "You enjoy solving, discovering, and uncovering new challenges.",
  ...
  },
  {
    ...
    label: "Quiz Master",
    tagline: "Learn & Earn",
    description: "You enjoy learning through knowledge-based challenges.",
  ...
  },
  {
    ...
    description: "You prefer a relaxed, low-pressure experience.",
  ...
  },
  {
    ...
    description: "You enjoy pushing your limits.",
  ...
  },
  {
    ...
    description: "You enjoy gradually building something over time.",
